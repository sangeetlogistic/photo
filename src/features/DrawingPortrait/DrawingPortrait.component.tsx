...
export const DraWingHeroSection = styled.section<{ detailPageCoverImage: string }>`
    position: relative;
    z-index: 1000;
...
`;
export const DrawingPageBackground = styled.div<{ backgroundRepeatImage: string }>`
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
export const DrawingPortraitsFAQCmp = styled.section`
    padding-top: 3.8vw;
